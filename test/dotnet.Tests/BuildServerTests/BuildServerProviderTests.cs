    ...
    public class BuildServerProviderTests : SdkTest
    {
        ...
        public void GivenMSBuildFlagItYieldsMSBuild()
        {
            ...
            provider
                ...
                .Select(s => s.Name)
                .Should()
                .Equal(CommonLocalizableStrings.MSBuildServer);
        }
        ...
        public void GivenVBCSCompilerFlagItYieldsVBCSCompiler()
        {
            ...
            provider
                ...
                .Select(s => s.Name)
                .Should()
                .Equal(CommonLocalizableStrings.VBCSCompilerServer);
        }
        ...
        public void GivenARazorPidFileItReturnsARazorBuildServer()
        {
            ...
            razorServer.Name.Should().Be(CommonLocalizableStrings.RazorServer);

...
namespace Microsoft.DotNet.Cli.MSBuild.Tests
{
    ...
    public class GivenDotnetRestoreInvocation : IClassFixture<NullCurrentSessionIdFixture>
    {
        ...
        [InlineData(new string[] { "-r", "<rid>" }, "-property:RuntimeIdentifiers=<rid>")]
        [InlineData(new string[] { "-r", "linux-amd64" }, "-property:RuntimeIdentifiers=linux-x64")]
        [InlineData(new string[] { "-r", "linux-arm64" }, "-property:RuntimeIdentifiers=linux-arm64")]
        [InlineData(new string[] { "-r", "<rid0>", "-r", "<rid1>" }, "-property:RuntimeIdentifiers=<rid0>%3B<rid1>")]
        [InlineData(new string[] { "-r", "win-x64", "--os", "linux", "--arch", "arm64" }, "-property:RuntimeIdentifier=linux-arm64 -property:RuntimeIdentifiers=win-x64")]
        [InlineData(new string[] { "-r", "win-x64", "-r", "osx-x64", "--os", "linux", "--arch", "arm64" }, "-property:RuntimeIdentifier=linux-arm64 -property:RuntimeIdentifiers=win-x64%3Bosx-x64")]
        [InlineData(new string[] { "--runtime", "<rid>" }, "-property:RuntimeIdentifiers=<rid>")]
        [InlineData(new string[] { "--runtime", "linux-amd64" }, "-property:RuntimeIdentifiers=linux-x64")]
        [InlineData(new string[] { "--runtime", "linux-arm64" }, "-property:RuntimeIdentifiers=linux-arm64")]
        [InlineData(new string[] { "--runtime", "<rid0>", "--runtime", "<rid1>" }, "-property:RuntimeIdentifiers=<rid0>%3B<rid1>")]
        [InlineData(new string[] { "--runtime", "win-x64", "--os", "linux", "--arch", "arm64" }, "-property:RuntimeIdentifier=linux-arm64 -property:RuntimeIdentifiers=win-x64")]
        [InlineData(new string[] { "--runtime", "win-x64", "--runtime", "osx-x64", "--os", "linux", "--arch", "arm64" }, "-property:RuntimeIdentifier=linux-arm64 -property:RuntimeIdentifiers=win-x64%3Bosx-x64")]

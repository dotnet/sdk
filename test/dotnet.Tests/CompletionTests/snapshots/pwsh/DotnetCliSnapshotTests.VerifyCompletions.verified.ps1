    ...
    switch ($command) {
        ...
        'testhost;run' {
            $staticCompletions = @(
                ...
                [CompletionResult]::new('--project', '-p', [CompletionResultType]::ParameterName, "Defines the path of the project file to run. Use path to the project file, or path to the directory containing the project file. If not specified, it defaults to the current directory.")

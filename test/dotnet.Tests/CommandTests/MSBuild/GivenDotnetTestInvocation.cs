...
namespace Microsoft.DotNet.Cli.MSBuild.Tests
{
    ...
    {
        private static readonly string[] ExpectedPrefix = ["-maxcpucount", "--verbosity:minimal", "-tlp:default=auto", "--nologo", "-restore", "-target:VSTest", "-property:NuGetInteractive=false"];

...
namespace Microsoft.DotNet.Tests.Commands.Tool
{
    ...
    public class ToolUpdateLocalCommandTests
    {
        ...
        public void WhenPassingIgnoreFailedSourcesItShouldNotThrow()
        {
            ...
            updateLocalCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        {
            _toolRestoreCommand.Execute(CancellationToken.None);
            _mockFeed.Packages[0].Version = _packageNewVersionA.ToNormalizedString();

            _defaultToolUpdateLocalCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        public void WhenRunWithUpdateAllItShouldUpdateFromManifestFile()
        {
            ...
            _toolUpdateAllLocalCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        public void WhenRunFromDirectorWithPackageIdItShouldUpdateFromManifestFile()
        {
            ...
            toolUpdateCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        {
            _fileSystem.File.Delete(_manifestFilePath);
            Action a = () => _defaultToolUpdateLocalCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        public void WhenRunWithExplicitManifestFileItShouldUpdateFromExplicitManifestFile()
        {
            ...
            toolUpdateLocalCommand.Execute(CancellationToken.None).Should().Be(0);
        ...
        public void WhenRunWithPackageIdItShouldShowSuccessMessage()
        {
            ...
            _reporter.Clear();
            _defaultToolUpdateLocalCommand.Execute(CancellationToken.None);
        ...
        public void GivenFeedVersionIsLowerRunPackageIdItShouldThrow()
        {
            ...
            _reporter.Clear();
            Action a = () => _defaultToolUpdateLocalCommand.Execute(CancellationToken.None);

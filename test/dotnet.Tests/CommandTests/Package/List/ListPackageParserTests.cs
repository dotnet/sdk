...
namespace Microsoft.DotNet.Tests.ParserTests
{
    public class ListPackageParserTests
    {
        ...
        public void ListPackageCanForwardInteractiveFlag()
        {
            ...
            result.OptionValuesToBeForwarded(new ListPackageCommandDefinition()).Should().ContainSingle("--interactive");
        ...
        public void ListPackageCanForwardVerbosityFlag(string inputOption, string value)
        {
            ...
            result
                .OptionValuesToBeForwarded(new ListPackageCommandDefinition())
                .Should()

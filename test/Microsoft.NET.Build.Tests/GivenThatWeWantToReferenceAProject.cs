...
namespace Microsoft.NET.Build.Tests
{
    ...
    public class GivenThatWeWantToReferenceAProject : SdkTest
    {
        ...
        [TestMethod]
        [RequiresMSBuildVersion("16.8.0.42407")]
        ...
        [DataRow("v4.6.2", false, "netstandard1.6", true, true, true)]
        [DataRow("v4.7.2", false, "netstandard1.6;net472", true, true, true)]
        [DataRow("v4.6.2", false, "netstandard1.6;net472", true, true, true)]

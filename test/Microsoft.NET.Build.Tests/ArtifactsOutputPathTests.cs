...
namespace Microsoft.NET.Build.Tests
{
    ...
    public class ArtifactsOutputPathTests : SdkTest
    {
        ...
        [Fact]
        public void ArtifactsPathOutsideRepoIsAddedAsSourceRoot()
        {
            // This tests the original issue scenario where ArtifactsPath is set to a location outside the repo
            var testProject = new TestProject()
            {
                Name = "SourceRootTest",
                IsExe = true,

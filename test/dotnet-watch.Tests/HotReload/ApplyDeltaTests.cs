    ...
    public class ApplyDeltaTests(ITestOutputHelper logger) : DotNetWatchTestBase(logger)
    {
        ...
        public async Task MetadataUpdateHandler_NoActions()
        {
            ...
            await App.WaitUntilOutputContains(
                "dotnet watch ⚠ [WatchHotReloadApp (net9.0)] Expected to find a static method 'ClearCache', 'UpdateApplication' or 'UpdateContent' on type 'AppUpdateHandler, WatchHotReloadApp, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null' but neither exists.");
        }
        ...
        public async Task MetadataUpdateHandler_Exception(bool verbose)
        {
            ...
            await App.WaitUntilOutputContains("dotnet watch ⚠ [WatchHotReloadApp (net9.0)] Exception from 'AppUpdateHandler.ClearCache': System.InvalidOperationException: Bug!");

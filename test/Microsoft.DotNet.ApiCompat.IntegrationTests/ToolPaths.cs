...
{
    /// <summary>
    /// Locates the published <c>apicompat</c> tool DLL that the IntegrationTests project's
    /// <c>_StageToolsUnderTest</c> target copies under <c>tools\Microsoft.DotNet.ApiCompat.Tool\</c>

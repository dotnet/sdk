...
public class ComputeEndpointsForCurrentProjectStaticWebAssetsTest
{
    [Fact]
    public void IncludesEndpointsForAssetsFromCurrentProject()
    {
        ...
        var task = new ComputeEndpointsForCurrentProjectStaticWebAssets
        {
        ...
        task.Endpoints[0].ItemSpec.Should().Be("candidate.js");

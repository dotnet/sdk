...
namespace Microsoft.DotNet.Cli.Run.Tests
{
    public class GivenDotnetRunRunsVbproj : SdkTest
    {
        ...
        public void ItFailsWhenTryingToUseLaunchProfileSharingTheSameNameWithAnotherProfileButDifferentCapitalization()
        {
            ...
            string expectedError = string.Format(Commands.LocalizableStrings.DuplicateCaseInsensitiveLaunchProfileNames, "\tfirst," + (OperatingSystem.IsWindows() ? "\r" : "") + "\n\tFIRST");
            runResult
                .Should()
                .Fail()
                .And
        ...
        public void ItFailsWithSpecificErrorMessageIfLaunchProfileDoesntExist()
        {
            ...
            new DotnetCommand(Log, "run")
                ...
                .Pass()
                .And
                .HaveStdErrContaining(string.Format(Commands.LocalizableStrings.LaunchProfileDoesNotExist, invalidLaunchProfileName));
        }

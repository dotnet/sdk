...
namespace Microsoft.DotNet.Cli.New.IntegrationTests
{
    public class CommonTemplatesTests : BaseIntegrationTest, IClassFixture<SharedHomeDirectory>
    {
        ...
        [InlineData("dotnet config file", "dotnetconfig", null)]
        [InlineData("dotnet config file", "dotnetconfig", new[] { "--runner", "Microsoft.Testing.Platform" })]
        [InlineData("dotnet config file", "dotnet.config", null)]
        [InlineData("dotnet config file", "dotnet.config", new[] { "--runner", "Microsoft.Testing.Platform" })]

...
public class DiffPropertyTests : DiffBaseTests
{
    ...
    public void PropertyIndentationFallback_UsesNestingDepthWhenLeadingTriviaIsMissing()
    {
        ...
        var fallbackLeadingTrivia = MemoryOutputDiffGenerator.GetLeadingTriviaForDiff(propertyWithMissingLeadingTrivia);
        Assert.Equal("        ", fallbackLeadingTrivia.ToFullString());
    }

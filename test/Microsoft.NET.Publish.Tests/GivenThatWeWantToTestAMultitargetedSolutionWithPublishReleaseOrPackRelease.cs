...
namespace Microsoft.NET.Publish.Tests
{
    ...
    public class GivenThatWeWantToTestAMultitargetedSolutionWithPublishReleaseOrPackRelease : SdkTest
    {
        ...
        public void ItUsesReleaseWithATargetFrameworkOptionNet8ForNet6AndNet7MultitargetingProjectWithPReleaseUndefined(params string[] args)
        {
            ...
            var expectedTfm = ToolsetInfo.CurrentTargetFramework;

            var (testAsset, testProjects) = Setup(new List<string> { "net6.0", "net7.0", "net8.0", "net9.0", "net10.0", "net11.0", ToolsetInfo.CurrentTargetFramework }, new List<string> { secondProjectTfm }, PublishRelease, "", "", identifier: string.Join('-', args));

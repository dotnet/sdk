...
namespace Microsoft.TemplateEngine.TestHelper
{
    public class EnvironmentSettingsHelper : IDisposable
    {
        ...
        public EnvironmentSettingsHelper(Action<string>? logAction = null)
        {
            ...
            IEnumerable<ILoggerProvider>? addLoggerProviders = null)
        {
            ...
            IEnumerable<ILoggerProvider> loggerProviders = _logAction is not null
                ? new[] { new TestLoggerProvider(_logAction) }
                : [];

    ...
    public class ConfigurationTests : BootstrapperTestBase
    {
        ...
        public async Task PhysicalConfigurationTest()
        {
            ...
            try
            {
                ...
                var result = await bootstrapper.GetTemplatesAsync(cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task VirtualConfigurationTest()
        {
            ...
            IReadOnlyList<InstallResult> installResult = await bootstrapper.InstallTemplatePackagesAsync(new[] { installRequest }, InstallationScope.Global, TestContext.CancellationTokenSource.Token);

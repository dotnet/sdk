...
namespace Microsoft.TemplateEngine.IDE.IntegrationTests
{
    ...
    public class End2EndTests : BootstrapperTestBase
    {
        ...
        public async Task SourceNameFormsTest()
        {
            ...
            var foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.SourceNameForms") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            var result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "MyApp.1", output, new Dictionary<string, string?>(), cancellationToken: TestContext.CancellationTokenSource.Token);
            ...
            SnapshotComparer.AssertEqualToApproval(this, File.ReadAllText(targetFile2));
        }
        ...
        public async Task ValueForms_DerivedSymbolTest()
        {
            ...
            var foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.ValueForms.DerivedSymbol") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            var result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "Real.Web.App", output, new Dictionary<string, string?>(), cancellationToken: TestContext.CancellationTokenSource.Token);
            ...
            SnapshotComparer.AssertEqualToApproval(this, File.ReadAllText(targetFile));
        }
        ...
        public async Task ValueForms_DerivedSymbolFromGeneratedSymbolTest()
        {
            ...
            var foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.ValueForms.DerivedSymbolFromGeneratedSymbol") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            var result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "Real.Web.App", output, new Dictionary<string, string?>(), cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task PortAndCoalesceTest_WithFallbackInput()
        {
            ...
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.TemplateWithPortsAndCoalesce") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            ITemplateCreationResult result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "test-template", output, new Dictionary<string, string?>(), cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task PortAndCoalesceTest_WithUserInput()
        {
            ...
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.TemplateWithPortsAndCoalesce") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            ITemplateCreationResult result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "test-template", output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task StringCoalesceTest_WithFallbackInput()
        {
            ...
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper.GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.TemplateWithStringCoalesce") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            ITemplateCreationResult result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "test-template", output, new Dictionary<string, string?>(), cancellationToken: TestContext.CancellationTokenSource.Token);
...
#pragma warning restore SA1122 // Use string.Empty for empty strings
        ...
        public async Task Test_CreateAsync_OnInvalidParamsPassed()
        {
            ...
            ITemplateCreationResult result = await bootstrapper.CreateAsync(foundTemplates[0].Info, "Test", output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task Test_DryRunAsync_OnInvalidParamsPassed()
        {
            ...
            ITemplateCreationResult result = await bootstrapper.GetCreationEffectsAsync(foundTemplates[0].Info, "Test", output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task Test_CreateAsync_OnTemplateWithConditions()
        {
            ...
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper
                .GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.TemplateWithConditions") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            ...
            ITemplateCreationResult result = await bootstrapper
                .CreateAsync(foundTemplates[0].Info, "Test", output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task Test_CreateAsync_PreferDefaultNameValidParameters(string? name, string expectedFileName)
        {
            ...
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper
                .GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.TemplateWithPreferDefaultName") }, cancellationToken: TestContext.CancellationTokenSource.Token);
            ...
            ITemplateCreationResult result = await bootstrapper
                .CreateAsync(foundTemplates[0].Info, name, output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task Test_CreateAsync_PreferDefaultNameInvalidParameters()
        {
            ...
            ITemplateCreationResult result = await bootstrapper
                .CreateAsync(foundTemplates[0].Info, null, output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);
        ...
        public async Task PostAction_WithFileRename_Test()
        {
            ...
            string output = TestUtils.CreateTemporaryFolder();
            IReadOnlyList<ITemplateMatchInfo> foundTemplates = await bootstrapper
                .GetTemplatesAsync(new[] { WellKnownSearchFilters.NameFilter("TestAssets.PostActions.AddJsonProperty.WithSourceNameChangeInJson") }, cancellationToken: TestContext.CancellationTokenSource.Token);

            // Using this parameter with no real info so bootstrapper.CreateAsync is not an ambiguous call
            Dictionary<string, string?> parameters = new();

            ITemplateCreationResult result = await bootstrapper
                .CreateAsync(foundTemplates[0].Info, "CompanyProject", output, parameters, cancellationToken: TestContext.CancellationTokenSource.Token);

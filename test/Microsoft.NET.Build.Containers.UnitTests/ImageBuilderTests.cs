...
public class ImageBuilderTests
{
    ...
    public void CanPreserveExistingPorts()
    {
        ...
        var resultPorts = result.Image.Config!.ExposedPorts;
    ...
    public void HistoryEntriesMatchNonEmptyLayers()
    {
        ...
        var historyNode = result.Image.History;
        Assert.NotNull(historyNode);

        var layerDiffsNode = result.Image.RootFS.DiffIDs;
        Assert.NotNull(layerDiffsNode);

        int nonEmptyHistoryNodes = historyNode.Count(h => h.EmptyLayer != true);
        int layerCount = layerDiffsNode.Count;

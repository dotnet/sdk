...
public class DigestUtilsTests
{
    ...
    [TestMethod]
    [DataRow("")] // empty
    [DataRow("sha256:")] // missing encoded value
    [DataRow("sha256:../..\\xyz_not_hex!!")] // path traversal / invalid characters
    [DataRow("c5098cc7c2a2ad9bfc66e4c4cb242683a578e9d8f25fd8730b289dd5667916ad")] // missing algorithm prefix
    [DataRow("0000000c5098cc7c2a2ad9bfc66e4c4cb242683a578e9d8f25fd8730b289dd5667916ad")] // correct string length, no algorithm prefix
    [DataRow("sha256:abc")] // too short for sha256
    [DataRow("sha256:c5098cc7c2a2ad9bfc66e4c4cb242683a578e9d8f25fd8730b289dd5667916a")] // 63 hex chars (1 too short for sha256)
    [DataRow("sha256:c5098cc7c2a2ad9bfc66e4c4cb242683a578e9d8f25fd8730b289dd5667916adF")] // uppercase hex not allowed per OCI spec
    [DataRow("sha256:c5098cc7c2a2ad9bfc66e4c4cb242683a578e9d8f25fd8730b289dd5667916ad000000000000")] // too long for sha256
    [DataRow("sha256:FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF")] // uppercase hex not allowed per OCI spec
    [DataRow("md5:5b0bcabd1ed22e9fb1310cf6")] // unregistered algorithm
    [DataRow("sha512:abc")] // sha512 not currently supported
    [DataRow("blake3:abc")] // blake3 not currently supported
    ...
    public void ComputeSha256Digest_ReturnsCorrectDigest()
    {
        ...
        Assert.AreEqual("sha256:e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855", digest);
    }
    ...
    public void ComputeSha256Digest_RoundTrips_Through_GetEncoded()
    {
        ...
        string encoded = DigestUtils.GetEncoded(digest);
        Assert.AreEqual(DigestUtils.ComputeSha256("hello world"), encoded);
    }
}

...
Please refer to [dotnet/cli](https://github.com/dotnet/cli) for .NET Core CLI source code, and to [dotnet/roslyn-project-system](https://github.com/dotnet/roslyn-project-system) for the project system work that is specific to Visual Studio "15".

...
| [SelfUpdateReplacement](../../../../src/Installer/dotnetup.Library/SelfUpdate/SelfUpdateReplacement.cs), [SelfUpdateVerifier](../../../../src/Installer/dotnetup.Library/SelfUpdate/SelfUpdateVerifier.cs) | Explicit per-update identity/backup state, flushed same-volume replacement, recovery, and bounded canonical execution verification with drained pipes. |
...
- Use a published NativeAOT executable, not the managed library or an ordinary
    ...
    ownership policy; see [SelfUpdatePaths](../../../../src/Installer/dotnetup.Library/SelfUpdate/SelfUpdatePaths.cs).

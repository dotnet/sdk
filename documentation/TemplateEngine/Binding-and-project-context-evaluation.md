...
If applicable, it is also recommended to use [project capability constraint](https://github.com/dotnet/sdk/blob/main/documentation/TemplateEngine/Constraints.md#Project-capabilities) to define the projects that the template can be added to.

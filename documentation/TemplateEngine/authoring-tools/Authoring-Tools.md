...
We have created [dotnet template samples](https://github.com/dotnet/sdk/tree/main/documentation/TemplateEngine/Samples), which shows how you can use the template engine to create new templates. The samples are setup to be stand alone for specific examples. Those templates are not published to NuGet.org.

...
Details
 ...
 - A `derived` `type` with a value transformation is performed using [value forms](https://github.com/dotnet/sdk/blob/main/documentation/TemplateEngine/Value-Forms.md) (`ValueForms` type).
 - The sample uses `replace`, `titleCase`, `kebabCase`, `firstLowerCaseInvariant` and `chain` value forms.
 - More value forms can be found in [the source code](https://github.com/dotnet/sdk/tree/main/src/TemplateEngine/Microsoft.TemplateEngine.Orchestrator.RunnableProjects/ValueForms).

...
The other examples of complex templates can be found in [Microsoft.TemplateEngine.TestTemplates](../../../test/TestAssets/TestPackages/TemplateEngine/test_templates) and [SDK.TestTemplates](../../../test/TestAssets/TestPackages/dotnet-new/test_templates) repositories.
...
We would love community contributions here. Please feel free to open the PRs to add more examples or create an [issue](https://github.com/dotnet/sdk/issues/new) requesting a new example.

See the [SDK developer guide](../../project-docs/developer-guide.md) for information on contributing to this project.

...
| --- | --- | --- |
| [`src/Cli`](../../src/Cli) | Managed CLI, shared AOT-safe command definitions, Native AOT bridge, template CLI integration, command resolution, telemetry, and utilities. Start with [`AGENTS.md`](../../src/Cli/AGENTS.md), [`Program.cs`](../../src/Cli/dotnet/Program.cs), [`Microsoft.DotNet.Cli.InternalMicrosoft`](../../src/Cli/Microsoft.DotNet.Cli.InternalMicrosoft), and [`DotNetCommandDefinition.cs`](../../src/Cli/Microsoft.DotNet.Cli.Definitions/Commands/DotNetCommandDefinition.cs). The internal-Microsoft library owns classification only; [`InternalMicrosoftTelemetry`](../../src/Cli/dotnet/Telemetry/InternalMicrosoft/InternalMicrosoftTelemetry.cs) adapts its results to CLI telemetry. | Consumes NuGet/MSBuild/Template Engine and SDK utilities; consumed by redist and CLI tests. |

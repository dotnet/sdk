...
| Restore or feed | [Build 1525302](https://dev.azure.com/dnceng-public/public/_build/results?buildId=1525302) | Arcade SDK acquisition failed when the dotnet10 feed returned HTTP 503. | Azure task logs; manually replayed through the collector. |

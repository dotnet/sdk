...
const COPILOT_PR_AUTHOR = "app/copilot-swe-agent";
const COPILOT_ASSIGNEE_LOGIN = "copilot-swe-agent";
...
{
    const query = `is:issue is:open repo:${owner}/${repo} label:${WORK_QUEUE_LABEL} -label:"${EXCLUDED_LABELS.join(
        '" -label:"',
    )}"`;

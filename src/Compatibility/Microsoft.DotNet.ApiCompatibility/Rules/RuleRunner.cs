...
namespace Microsoft.DotNet.ApiCompatibility.Rules
{
    internal class RuleRunner : IRuleRunner
    {
        ...
        internal RuleRunner(string leftName, string[] rightNames, bool strictMode, IEqualityComparer<ISymbol> symbolComparer)
        {
            _context = new RuleRunnerContext();
            _settings = new RuleSettings(strictMode, symbolComparer);
            _leftName = leftName;

...
namespace Microsoft.NetCore.Analyzers.Runtime.UnitTests
{
    ...
    public class PreferStreamWriteAsyncMemoryOverloadsTest : PreferStreamAsyncMemoryOverloadsTestBase
    {
        ...
        private static string CreateCSharpSource(string streamTypeName, string byteArrayDeclaration, string arguments, string configureAwait) => $$"""
            ...
            class C
            {
                public async void M()
                {
                    using ({{streamTypeName}} s = new FileStream("path.txt", FileMode.Create))
                    {
                        {{byteArrayDeclaration}}
                        await s.WriteAsync({{arguments}}){{configureAwait}};
                    }
                }
            }
        ...
        [TestMethod]
        [DynamicData(nameof(CSharpInlinedByteArrayTestData))]
        ...
        private static string CreateVisualBasicSource(string streamTypeName, string byteArrayDeclaration, string arguments, string configureAwait) => $$"""
            ...
            Public Module C
                Public Async Sub M()
                    Using s As {{streamTypeName}} = New FileStream("file.txt", FileMode.Create)
                        {{byteArrayDeclaration}}
                        Await s.WriteAsync({{arguments}}){{configureAwait}}
                    End Using
                End Sub
        ...
        [TestMethod]
        [DynamicData(nameof(VisualBasicInlinedByteArrayTestData))]
        ...
        private Task CSharpVerifyCodeFixAsync(string originalArgs, string fixedArgs, string streamTypeName, bool isEmptyByteDeclaration, bool isEmptyConfigureAwait) =>
            CSharpVerifyExpectedCodeFixDiagnosticsAsync(
                CreateCSharpSource(streamTypeName, GetByteArrayWithDataCSharp(isEmptyByteDeclaration), originalArgs, GetConfigureAwaitCSharp(isEmptyConfigureAwait)),
                CreateCSharpSource(streamTypeName, GetByteArrayWithDataCSharp(isEmptyByteDeclaration), fixedArgs, GetConfigureAwaitCSharp(isEmptyConfigureAwait)),
        ...
        private Task VisualBasicVerifyCodeFixAsync(string originalArgs, string fixedArgs, string streamTypeName, bool isEmptyByteDeclaration, bool isEmptyConfigureAwait) =>
            VisualBasicVerifyExpectedCodeFixDiagnosticsAsync(
                CreateVisualBasicSource(streamTypeName, GetByteArrayWithDataVisualBasic(isEmptyByteDeclaration), originalArgs, GetConfigureAwaitVisualBasic(isEmptyConfigureAwait)),
                CreateVisualBasicSource(streamTypeName, GetByteArrayWithDataVisualBasic(isEmptyByteDeclaration), fixedArgs, GetConfigureAwaitVisualBasic(isEmptyConfigureAwait)),

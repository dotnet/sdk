...
class TestClass
{
    public void TestMethod()
    {
        ...
        [TestMethod]
        [DataRow("")]
        [DataRow("dotnet_code_quality.excluded_symbol_names = ExampleMethod")]
        [DataRow("dotnet_code_quality.CA5378.excluded_symbol_names = ExampleMethod")]
        [DataRow("dotnet_code_quality.CA5378.excluded_symbol_names = ExampleMet*")]
        [DataRow("dotnet_code_quality.dataflow.excluded_symbol_names = ExampleMethod")]

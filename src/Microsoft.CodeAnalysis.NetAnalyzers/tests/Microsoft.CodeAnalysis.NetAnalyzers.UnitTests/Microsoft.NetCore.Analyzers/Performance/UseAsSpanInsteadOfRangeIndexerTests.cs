...
#pragma warning restore CA1819
        ...
        public async Task ArrayToReadOnlySpanParameterAsync(string typeName)
        {
            await TestCSAsync("""
                ...
                public class TestClass
                {
                    private static int TestMethod2(ReadOnlySpan<
                """ + typeName + """
        > input) => input.Length;
        ...
        [] input)
            {
                ReadOnlySpan<
        """ + typeName + "> tmp = (ReadOnlySpan<" + typeName + """
            >)input[3..5];
                    return tmp.Length;
                }
            }
        ...
        [] input)
            {
                return TestMethod2((ReadOnlySpan<
        """ + typeName + """
            >)input[3..5]);
                }
            }
        ...
        public async Task ArrayToSpanParameterAsync(string typeName)
        {
            await TestCSAsync("""
                ...
                public class TestClass
                {
                    private static int TestMethod2(Span<
                """ + typeName + """
        > input) => input.Length;
        ...
        public async Task ArrayToReadOnlyMemoryParameterAsync(string typeName)
        {
            await TestCSAsync("""
                ...
                public class TestClass
                {
                    private static int TestMethod2(ReadOnlyMemory<
                """ + typeName + """
        > input) => input.Length;
        ...
        [] input)
            {
                ReadOnlyMemory<
        """ + typeName + "> tmp = (ReadOnlyMemory<" + typeName + """
            >)input[3..5];
                    return tmp.Length;
                }
            }
        ...
        [] input)
            {
                return TestMethod2((ReadOnlyMemory<
        """ + typeName + """
            >)input[3..5]);
                }
            }
        ...
        public async Task ArrayToMemoryParameterAsync(string typeName)
        {
            await TestCSAsync("""
                ...
                public class TestClass
                {
                    private static int TestMethod2(Memory<
                """ + typeName + """
        > input) => input.Length;

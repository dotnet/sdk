...
#pragma warning disable IDE0039 // Use local function
                Action<OperationAnalysisContext> operationAction = context =>
                {
                    ...
                    if (fieldInitializerValue == null ||
                        ...
                        (lastField.Type.Name == lastField.Name && fieldInitializerValue.DescendantsAndSelf().Any(d => d is IFieldReferenceOperation field && field.Field.Type.Equals(lastField.Type, SymbolEqualityComparer.Default))) ||

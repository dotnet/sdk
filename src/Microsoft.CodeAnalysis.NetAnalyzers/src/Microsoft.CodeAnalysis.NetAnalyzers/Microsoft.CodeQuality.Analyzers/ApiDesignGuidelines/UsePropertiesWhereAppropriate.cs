...
namespace Microsoft.CodeQuality.Analyzers.ApiDesignGuidelines
{
    ...
    public sealed class UsePropertiesWhereAppropriateAnalyzer : DiagnosticAnalyzer
    {
        ...
        internal static readonly DiagnosticDescriptor Rule = DiagnosticDescriptorHelper.Create(
            RuleId,
            CreateLocalizableResourceString(nameof(UsePropertiesWhereAppropriateTitle)),
            CreateLocalizableResourceString(nameof(UsePropertiesWhereAppropriateMessage)),
            DiagnosticCategory.Design,
            RuleLevel.Disabled,    // Heuristic based rule.
            description: CreateLocalizableResourceString(nameof(UsePropertiesWhereAppropriateDescription)),

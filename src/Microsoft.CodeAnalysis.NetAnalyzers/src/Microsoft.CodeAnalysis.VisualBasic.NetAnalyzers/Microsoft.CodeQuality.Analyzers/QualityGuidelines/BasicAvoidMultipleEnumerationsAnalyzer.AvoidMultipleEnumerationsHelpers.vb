...
Namespace Microsoft.CodeQuality.VisualBasic.Analyzers.QualityGuidelines
    Friend Class BasicAvoidMultipleEnumerationsAnalyzer
        Private Class BasicAvoidMultipleEnumerationsHelpers
            ...
            Public Overrides Function IsInvocationDeferredExecutingInvocationInstance(invocationOperation As IInvocationOperation, wellKnownSymbolsInfo As WellKnownSymbolsInfo) As Boolean
            ...
            Protected Overrides Function IsOperationTheInstanceOfDeferredInvocation(operation As IOperation, wellKnownSymbolsInfo As WellKnownSymbolsInfo) As Boolean
                ...
                Return parentInvocationOperation IsNot Nothing AndAlso IsInvocationDeferredExecutingInvocationInstance(parentInvocationOperation, wellKnownSymbolsInfo)
            End Function
        End Class
    End Class
End Namespace
...
internal static class ValidationUtility
{
    public static void ValidateMutuallyExclusiveOptions(ParseResult parseResult, PathOptions pathOptions)
    {
        ...
        void ValidatePathOptions(ParseResult parseResult, PathOptions pathOptions)
        {
            var count = 0;
        ...
        void ValidateOptionsIrrelevantToModulesFilter(ParseResult parseResult, string? testModules)
        {

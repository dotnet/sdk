...
internal static class MSBuildUtility
{
    ...
    {
        SolutionModel solutionModel = SolutionModelUtils.CreateFromFileOrDirectory(solutionFilePath, includeSolutionFilterFiles: true, includeSolutionXmlFiles: true);

...
internal abstract class WorkloadCommandDefinitionBase : Command
{
    public WorkloadCommandDefinitionBase(string name, string description)
    ...
    public static Option<bool> CreateSkipManifestUpdateOption() => new("--skip-manifest-update")
    {

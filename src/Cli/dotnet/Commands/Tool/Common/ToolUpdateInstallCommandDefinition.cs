...
internal abstract class ToolUpdateInstallCommandDefinition : System.CommandLine.Command
{
    ...
    public readonly ToolLocationOptions LocationOptions = new(
        globalOptionDescription: CliCommandStrings.ToolInstallGlobalOptionDescription,
        localOptionDescription: CliCommandStrings.ToolInstallLocalOptionDescription,
        toolPathOptionDescription: CliCommandStrings.ToolInstallToolPathOptionDescription);
    ...
    public readonly Option<string> ToolManifestOption = ToolAppliedOption.CreateToolManifestOption(CliCommandStrings.ToolInstallManifestPathOptionDescription);

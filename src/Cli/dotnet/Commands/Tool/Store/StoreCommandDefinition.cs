...
internal sealed class StoreCommandDefinition : Command
{
    ...
    public readonly Option<string> FrameworkOption = CommonOptions.CreateFrameworkOption(CliCommandStrings.StoreFrameworkOptionDescription);
    public readonly Option<string> RuntimeOption = TargetPlatformOptions.CreateRuntimeOption(CliCommandStrings.StoreRuntimeOptionDescription);
    public readonly Option<Utils.VerbosityOptions?> VerbosityOption = CommonOptions.CreateVerbosityOption();
    public readonly Option<bool> UseCurrentRuntimeOption = CommonOptions.CreateUseCurrentRuntimeOption(CliCommandStrings.CurrentRuntimeOptionDescription);
    ...
    public StoreCommandDefinition()
        : base("store", CliCommandStrings.StoreAppDescription)
    {
        this.DocsLink = Link;

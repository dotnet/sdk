...
{
    public ForwardingRestoreCommand SeparateRestoreCommand { get; }
    ...
    private static ForwardingRestoreCommand GetSeparateRestoreCommand(
        IEnumerable<string> arguments,
        bool noRestore,
        string msbuildPath)
    {
        ...
        return new ForwardingRestoreCommand(restoreArguments, msbuildPath);
    }

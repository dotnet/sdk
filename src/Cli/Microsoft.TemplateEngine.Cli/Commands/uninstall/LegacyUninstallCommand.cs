...
{
    internal sealed class LegacyUninstallCommand(Func<ParseResult, ITemplateEngineHost> hostBuilder)
        : BaseUninstallCommand(hostBuilder, new UninstallCommandDefinition(isLegacy: true))
    {

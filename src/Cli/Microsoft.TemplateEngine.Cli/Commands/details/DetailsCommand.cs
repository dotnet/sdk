...
{
    internal sealed class DetailsCommand(Func<ParseResult, ITemplateEngineHost> hostBuilder, DetailsCommandDefinition definition)
        : BaseCommand<DetailsCommandArgs, DetailsCommandDefinition>(hostBuilder, definition)
    {

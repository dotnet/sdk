            ...
            string? defaultLanguage)
        {
            ...
            TabularOutput<SearchResultTableRow> formatter =
               TabularOutput.TabularOutput
                    ...
                    .DefineColumn(r => r.TemplateGroupInfo.Author, LocalizableStrings.ColumnNameAuthor, TabularOutputColumnNames.Author, defaultColumn: false, shrinkIfNeeded: true, minWidth: 12)
                    .DefineColumn(r => r.TemplateGroupInfo.Languages, LocalizableStrings.ColumnNameLanguage, TabularOutputColumnNames.Language, defaultColumn: true)
                    .DefineColumn(r => r.TemplateGroupInfo.Type, LocalizableStrings.ColumnNameType, TabularOutputColumnNames.Type, defaultColumn: false)
                    .DefineColumn(r => r.TemplateGroupInfo.Classifications, LocalizableStrings.ColumnNameTags, TabularOutputColumnNames.Tags, defaultColumn: false, shrinkIfNeeded: true, minWidth: 10)

...
// Pulled from dotnet/msbuild (src/Framework/Utilities/BufferScope.cs) so the Native AOT CLI can grow
// a stack-allocated buffer for Win32 P/Invokes (e.g. GetModuleFileName) without heap-allocating in the
// common case. Kept in sync with the upstream version.

...
// Pulled from dotnet/msbuild (src/Framework/Utilities/TypeInfo.cs); a dependency of BufferScope used to
// decide whether ArrayPool buffers must be cleared on return. Kept in sync with the upstream version.

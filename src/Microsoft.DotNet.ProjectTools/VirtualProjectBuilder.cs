...
public sealed class VirtualProjectBuilder
{
    ...
    internal static SourceFile RemoveDirectivesFromFile(ImmutableArray<CSharpDirective> directives, SourceFile sourceFile)
    {
        ...
        return sourceFile with { Text = text };
    }

    internal static void RemoveDirectivesFromFile(ImmutableArray<CSharpDirective> directives, SourceFile sourceFile, string targetFilePath)
    {

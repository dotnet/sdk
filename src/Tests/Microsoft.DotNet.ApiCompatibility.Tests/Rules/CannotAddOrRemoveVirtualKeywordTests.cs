...
";
        ...
        [Fact]
        public static void EnsureDiagnosticIsLoggedWhenMakingAbstractMemberVirtualInStrictMode()
        {
            string leftSyntax = @"
namespace CompatTests
{
...
";
            ...
            CompatDifference[] expected = new[]
            {
                new CompatDifference(DiagnosticIds.CannotAddVirtualToMember, string.Empty, DifferenceType.Added, "M:CompatTests.First.H"),
            };
            Assert.Equal(expected, differences);
        }
    }

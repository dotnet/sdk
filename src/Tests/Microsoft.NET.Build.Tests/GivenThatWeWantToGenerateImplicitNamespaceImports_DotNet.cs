...
");
        ...
        [Fact]
        public void It_can_generate_static_imports()
        {
            var tfm = "net6.0";
            var testProject = CreateTestProject(tfm);
            testProject.AdditionalProperties["DisableImplicitNamespaceImports_DotNet"] = "true";
            testProject.AdditionalItems["Import"] = new Dictionary<string, string> { ["Include"] = "static System.Console" };
            var testAsset = _testAssetsManager.CreateTestProject(testProject);
            var importFileName = $"{testAsset.TestProject.Name}.ImplicitNamespaceImports.cs";
...
");
        ...
        [Fact]
        public void It_can_generate_alias_imports()
        {
            var tfm = "net6.0";
            var testProject = CreateTestProject(tfm);
            testProject.AdditionalProperties["DisableImplicitNamespaceImports_DotNet"] = "true";
            testProject.AdditionalItems["Import"] = new Dictionary<string, string> { ["Include"] = "SomeAlias = System.Console" };
            var testAsset = _testAssetsManager.CreateTestProject(testProject);
            var importFileName = $"{testAsset.TestProject.Name}.ImplicitNamespaceImports.cs";
            ...
            File.ReadAllText(Path.Combine(outputDirectory.FullName, importFileName)).Should().Be(
                @"// <autogenerated />
global using SomeAlias = global::System.Console;
");
        }

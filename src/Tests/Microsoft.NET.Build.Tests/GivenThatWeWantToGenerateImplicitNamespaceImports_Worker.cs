...
namespace Microsoft.NET.Build.Tests
{
    ...
    {
        private const string _testProjectName = "TestWorkerApp";
        private const string _importFileName = "WorkerApp.ImplicitNamespaceImports.cs";
        ...
        public void It_can_disable_worker_imports()
        {
            ...
            var testAsset = _testAssetsManager
                ...
                .WithProjectChanges(p =>
                {
                    ...
                    propertyGroup.Add(new XElement(ns + "DisableImplicitNamespaceImports_Worker", "true"));
                });

...
namespace Microsoft.DotNet.Cli.Workload.Install.Tests
{
    public class GivenNetSdkManagedWorkloadInstall : SdkTest
    {
            ...
            PackageSourceLocation packageSourceLocation = null)
        {
            ...
            return (dotnetRoot, new NetSdkManagedInstaller(_reporter, sdkFeatureBand, workloadResolver, nugetInstaller, dotnetRoot, tempDirPath: testDirectory, packageSourceLocation: packageSourceLocation), nugetInstaller);
        }
    }
}

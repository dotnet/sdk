...
public class DockerDaemonTests : IDisposable
{
    ...
    [DockerAvailableFact(Skip = "https://github.com/dotnet/sdk/issues/49502", skipPodman: true)] // podman is a local cli not meant for connecting to remote Docker daemons.

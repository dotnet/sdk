...
namespace Microsoft.NET.TestFramework
{
    public class TestAsset : TestDirectory
    {
        ...
        public TestAsset WithSource()
        {
            ...
            string[][] objItem = { new string[] { "TargetFramework", "CurrentTargetFramework", ToolsetInfo.CurrentTargetFramework }, new string[] { "RuntimeIdentifier", "LastWinRuntimeIdentifier", ToolsetInfo.LastWinRuntimeIdentifier } };

            foreach (string[] obj in objItem)
            {

...
{ } }";
            ...
            new CompatibleFrameworkInPackageValidator(log).Validate(new(package));
            ...
            new CompatibleFrameworkInPackageValidator(log).Validate(new(package, frameworkReferences: references));
        ...
        public void ValidateOnlyErrorWhenAReferenceIsRequired(bool createDependencyToDummy, bool useReferences, bool shouldLogError)
        {
            ...
            // removed an interface due to it's base class removing that implementation. We validate that APICompat doesn't
            // log errors when not using references.
            new CompatibleFrameworkInPackageValidator(log).Validate(new(package, frameworkReferences: useReferences ? references : null));
            if (shouldLogError)

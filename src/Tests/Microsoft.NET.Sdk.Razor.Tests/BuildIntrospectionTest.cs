...
namespace Microsoft.NET.Sdk.Razor.Tests
{
    public class BuildIntrospectionTest : SdkTest
    {
        ...
        public void IntrospectRazorTasksDllPath()
        {
            ...
            var expected = Path.Combine("Sdks", "Microsoft.NET.Sdk.Razor", "tasks", "net6.0", "Microsoft.NET.Sdk.Razor.Tasks.dll");
            ...
            build.Execute()
                ...
                .And.HaveStdOutContaining(expected);
        }
        ...
        public void IntrospectRazorTasksDllPath_DesktopMsBuild()
        {
            ...
            var tfm = "net6.0";
            var expected = Path.Combine("Sdks", "Microsoft.NET.Sdk.Razor", "tasks", tfm, "Microsoft.NET.Sdk.Razor.Tasks.dll");

            // Verifies the fix for https://github.com/dotnet/aspnetcore/issues/17308
            var build = new MSBuildCommand(Log, "_IntrospectRazorTasks", projectDirectory.Path);
            build.Execute().Should().Pass().And.HaveStdOutContaining(expected);
        }

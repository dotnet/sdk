...
namespace Microsoft.NET.Sdk.Razor.Tests
{
    public class MvcBuildIntegrationTest21 : MvcBuildIntegrationTestLegacy
    {
        ...
        [Fact]
        public virtual void Build_DoesNotAddRelatedAssemblyPart_IfToolSetIsNotRazorSdk()
        {
        ...
        [Fact]
        public virtual void Publish_NoopsWithMvcRazorCompileOnPublish_False()
        {
            using (CreateTestProject())
            {
        ...
        public virtual void Build_WithMvcRazorCompileOnPublish_Noops()
        {
            using (CreateTestProject())
            {
                var build = new BuildCommand(Project);

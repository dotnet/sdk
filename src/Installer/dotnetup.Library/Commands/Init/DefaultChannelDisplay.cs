...
/// <summary>
/// The information needed to render the init form's default SDK channel. Derived from the
/// already-resolved default install request so the displayed channel matches exactly what would be
/// installed when the user accepts the defaults.
/// </summary>
